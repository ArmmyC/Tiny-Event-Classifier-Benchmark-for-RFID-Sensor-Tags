.PHONY: data eval benchmark sweep snn-search temporal-benchmark temporal-sweep temporal-snn-search temporal-snn-optimize temporal-snn-v2-search software-evidence research-report research-writeup rtl-vectors rtl-sim rtl-synth rtl-activity rtl-report rtl-compare rtl-evidence evidence evidence-manifest artifact-card evidence-smoke test clean
